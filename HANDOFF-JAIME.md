...
El sitio ya está en línea y funcionando — esto **no** es un lanzamiento nuevo, es una actualización de archivos. Dos cambios:
...
Descomprímelo y vas a ver una carpeta `dist-multipage` con **15 archivos** dentro (HTML, CSS, una imagen y la configuración). Si prefieres que te lo pase por WhatsApp, dime y te lo envío.
...
5. Click **Upload** → sube los **15 archivos** que están *dentro* de `dist-multipage` (sube el **contenido** de la carpeta, no la carpeta misma).
